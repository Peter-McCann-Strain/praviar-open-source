...
// Only load Clerk components when properly configured
...
export function SignInContent() {
  ...
  if (!ClerkSignIn) {
    return (
      <AuthUnavailableState title="Sign In" checkoutIntent={checkoutIntent} />
    );
  }

  return (
    <ClerkRuntimeBoundary title="Sign In" checkoutIntent={checkoutIntent}>
      <ClerkSignIn
