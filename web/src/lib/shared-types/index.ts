...
// Keep FDA listing metadata faithful to the generated API contract. Historical
// and provider-backed records can legitimately contain only NDA/use-code
// evidence, so the descriptive arrays must remain optional.
export type OrangeBookInfo = Generated.OrangeBookInfo;
