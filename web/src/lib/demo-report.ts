  ...
  claims_analyzed: [
    {
      ...
      reasoning:
        "Three of four elements are met. The yield limitation (element 4) requiring \u22650.8 mol/mol is the only unmet element. Current process yields of 0.65-0.72 mol/mol fall short; process optimization or Doctrine of Equivalents treatment is a candidate review cue for patent counsel.",
    },
    {
      claim_number: 2,
...
const DOE_ASSESSMENTS: DoEAssessment[] = [
  {
    ...
    reasoning:
      "Although the function and way prongs appear aligned, the result prong is flagged because there is a meaningful quantitative difference between the actual yield (0.65-0.72) and the claimed yield (0.8). The prosecution record also indicates the applicant narrowed the yield limitation from 0.5 to 0.8 during prosecution to overcome a prior art rejection. This creates a prosecution-history estoppel review cue for yields below 0.8 mol/mol, including the evaluated process.",
  },
  {
    patent_id: "US0000000002A1",
    claim_number: 1,
    ...
    confidence_band: "MODERATE",
    reasoning:
      "The purity limitation is flagged for Function-Way-Result review. The difference between 99.2% and 99.5% purity may be argued as insubstantial because both values produce polymer- and pharmaceutical-grade succinic acid. No narrowing amendment was detected for the purity limitation in the reviewed prosecution record. Patent counsel should review whether batches achieving 99.2% purity create Doctrine of Equivalents exposure.",
  },
  {
    patent_id: "US0000000001A1",
    claim_number: 5,
...
const INVALIDITY_ASSESSMENTS: InvalidityAssessment[] = [
  {
    ...
    graham_factors: {
      ...
      overall_obviousness_assessment:
        "The claimed method is flagged for obviousness review by a person of ordinary skill. The combination of Fictional Beta (teaching ppc overexpression) with Fictional Alpha (teaching high-yield succinate production in E. coli) may provide motivation to overexpress reductive TCA genes in high-yielding strains. The PTAB's denial of institution appears tied to insufficient petitioner briefing rather than a substantive finding of non-obviousness.",
    },
  ...
  },
  {
    ...
    graham_factors: {
      ...
      overall_obviousness_assessment:
        "The claimed process is flagged for obviousness review. Controlled cooling crystallization at specified rates is described as standard practice in the reviewed sources, and the 99.5% purity threshold may be achievable through routine optimization of crystallization conditions.",
    },
...
const SOURCE_HEALTH: SourceHealth = {
  entries: [
    ...
    },
    {
      ...
      patent_count: 0,
      error_message:
        "ConnectionError: PatCID API returned HTTP 503 Service Unavailable after 3 retries with exponential backoff. Last attempt at 2026-07-01T14:23:45Z.",
    },
  ],
};
...
const TIMING_DATA = [
  {
    ...
    started_at: "2026-07-01T14:20:01.000Z",
    completed_at: "2026-07-01T14:20:02.200Z",
  ...
  },
  {
    ...
    started_at: "2026-07-01T14:20:02.200Z",
    completed_at: "2026-07-01T14:20:14.600Z",
  ...
  },
  {
    ...
    started_at: "2026-07-01T14:20:14.600Z",
    completed_at: "2026-07-01T14:20:23.300Z",
  ...
  },
  {
    ...
    started_at: "2026-07-01T14:20:23.300Z",
    completed_at: "2026-07-01T14:21:08.500Z",
  ...
  },
  {
    ...
    started_at: "2026-07-01T14:21:08.500Z",
    completed_at: "2026-07-01T14:21:30.100Z",
  ...
  },
  {
    ...
    started_at: "2026-07-01T14:21:30.100Z",
    completed_at: "2026-07-01T14:22:04.400Z",
  ...
  },
  {
    ...
    started_at: "2026-07-01T14:22:04.400Z",
    completed_at: "2026-07-01T14:22:09.800Z",
  ...
  },
  {
    ...
    started_at: "2026-07-01T14:22:09.800Z",
    completed_at: "2026-07-01T14:22:13.100Z",
...
const CLAIM_SOURCE_SPAN_MAP = {
  generated_from: "demo_report_fixture",
  entries: [
    {
      assertion_id: "assertion-demo-meridian-claim-1-element-1",
      patent_id: "US0000000001A1",
      claim_number: 1,
      element_number: 1,
      report_section: "claim_element_analysis",
      assertion_text:
        "Claim 1 element 1 was assessed as met for recombinant prokaryotic production of succinic acid.",
      source_span_ids: ["span-demo-meridian-claim-1-element-1"],
  ...
  spans: {
    "span-demo-meridian-claim-1-element-1": {
      span_id: "span-demo-meridian-claim-1-element-1",
...
} satisfies NonNullable<FTOReport["claim_source_span_map"]>;

const PATENT_DETAILS = {
  US0000000001A1: {
    patent_id: "US0000000001A1",
    title:
      "Methods for producing C4 dicarboxylic acids using engineered prokaryotic microorganisms",
    abstract:
      "A fermentation process for producing C4 dicarboxylic acids using recombinant prokaryotic microorganisms engineered to increase reductive TCA branch flux.",
    claims_text:
      "1. A method for producing a C4 dicarboxylic acid comprising culturing a recombinant prokaryotic microorganism; wherein the microorganism has been genetically modified to overexpress at least one gene in the reductive TCA branch; in a culture medium comprising a carbon source selected from glucose, glycerol, or sucrose at a concentration of 20-200 g/L; and recovering the C4 dicarboxylic acid at a yield of at least 0.8 mol/mol carbon source.",
    claims_text_source: "demo_fixture",
    sources: ["demo_report_fixture"],
    confidence_score: 0.94,
    filing_date: "2015-06-14",
    priority_date: "2014-06-14",
    expiry_date: "2035-06-14",
    assignees: ["Fictional Meridian Therapeutics"],
    inventors: ["Fictional Inventor One", "Fictional Inventor Two"],
    cpc_codes: ["C12P 7/46", "C12N 15/74"],
    legal_status: "active",
...
} satisfies Record<string, PatentHit>;

const ADAPTIVE_DECISION_NOTES: ReasoningTrace[] = [
  {
    patent_id: "US0000000001A1",
    step: "claim_analysis",
    model: "synthetic-adaptive-review-v1",
    summary:
      "Synthetic demo note showing why the highest-risk claim received an additional evidence pass.",
    agent_type: "claim_analysis",
    confidence: 0.91,
    self_critique:
      "The first pass relied too heavily on functional similarity, so the review required claim-element citations and legal-status confirmation.",
    revisions_made: [
      "Attached claim-element source spans.",
      "Separated literal claim support from doctrine-of-equivalents risk.",
    ],
    final_output_summary:
      "The active US family remains the principal blocking record; counsel should verify claim construction and production-route facts before reliance.",
    rounds: [
      {
        round_number: 1,
        agent_name: "adaptive_claim_review",
        role: "evidence escalation",
        thinking_summary:
          "Compared the proposed fermentation route with the independent claim and checked whether each customer-visible assertion retained a source span.",
        tool_calls: [
          {
            tool_name: "claim_source_span_review",
            duration_ms: 840,
            tool_output_summary:
              "Three material claim elements retained customer-visible citations.",
          },
          {
            tool_name: "legal_status_check",
            duration_ms: 610,
            tool_output_summary:
              "The synthetic demo record remains active in the selected jurisdiction.",
          },
        ],
        observations:
          "The microorganism, pathway modification, and recovery limitations remain material to the risk assessment.",
        scratchpad_delta: {
          evidence_records_reviewed: 3,
          unsupported_customer_visible_claims: 0,
        },
        decision:
          "Retain high-risk classification and route the record to counsel review.",
        input_tokens: 1820,
        output_tokens: 410,
        duration_ms: 1980,
        revisions: ["Added explicit evidence boundaries."],
      },
    ],
...
export const TEST_REPORT: FTOReport = {
  ...
  generated_at: "2026-07-01T14:22:13.100Z",
  praviar_pipeline_version: "0.9.4",
  execution_profile: "world_class_adaptive",
  reasoning_traces: ADAPTIVE_DECISION_NOTES,
  ...
  claim_source_span_map: CLAIM_SOURCE_SPAN_MAP,
